...
import "../dao/MetaVaultAuthority.sol";
import "../shared/interfaces/IStaking.sol";

contract sMVD is ERC20Permit, MetaVaultAC {
    ...
    constructor(address _authority) ERC20("Staked Metavault", "sMVD", 9) ERC20Permit() MetaVaultAC(IMetaVaultAuthority(_authority)) {
    ...
    function setIndex(uint256 _INDEX) external onlyGovernor returns (bool) {
        //require( INDEX == 0 );
    ...
    /**
        @notice increases sMVD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMVD
