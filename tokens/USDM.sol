...
contract USDM is ERC20Permit, MetaVaultAC {
    using SafeMath for uint256;

    constructor(address _authority) ERC20("Metavault USD", "USDM", 18) ERC20Permit() MetaVaultAC(IMetaVaultAuthority(_authority)) {}
